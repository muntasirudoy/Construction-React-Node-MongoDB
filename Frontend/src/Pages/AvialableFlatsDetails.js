         ...
         <Container>
                     <Row>
                         ...
                         <Col lg={7} sm={12} md={7}>
                               ...
                               <h1 style={{fontWeight:"700",color:"#957B5F"}}>{flatdata.ProjectName}</h1>
                               <p style={{marginTop:"20px",color:"#353535",fontSize:"14px"}}>{flatdata.description}</p> 
                               <div className="table"> 
                               <table>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                       ...
                                       <Tr left="Number of Building Blocks" right={flatdata.nbuildblock} />
                                       ...
                                       <Tr left="RAJUK Approval Date" right={flatdata.rapprovaldate} />
                                       <Tr left="Rajuk Approval No" right={flatdata.rapprovalno} />
                                       <Tr left="Status" right={<Tag style={{background:"grey"}} value={flatdata.status}></Tag>} />
