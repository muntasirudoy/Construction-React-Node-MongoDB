            ...
            <Row gutter={[24, 16]}>
              <Col span={12}>
                <div className="detail-heading">
                  ...
                  <h2>
                    We Create Buildings That <br />
                    <span>Meet Your Needs.</span>{" "}
                  </h2>
                  <p>
                    Buildtab is the creative enterprise, where innovation is a
                    way of life. We are uniquely resourced with end-to-end
                    services to take clients from inspiration through core
                    conceptualization.
                  </p>
                </div>
                <div className="detail-list">
                  <ul>
                    ...
                    <li>
                      <SwapRightOutlined />A Great Project Management{" "}
                    </li>
                  </ul>
                  <div className="list-right">
                    <p className="list-para">
                      1200 <br /> <span>Satisfied Patients</span>{" "}
                    </p>
                    <img
                      style={{
                        width: "30%",
